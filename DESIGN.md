...
## Palette
- Sfondo: gradiente a 150° `--g1 #5b4bff → --g2 #b04bff → --g3 #ff5b9e` (indaco→viola→rosa), `background-attachment:fixed`. Tema **teal** per il Test 2 (`body[data-theme="teal"]`: `#0891b2 → #0d9488 → #84cc16`).
